						...
						<ul id="identfy_all">
							<li>
								<span class="identifying">
									...
									<img src="${pageContext.request.contextPath }/<%=response.encodeURL("code")%>" width="120px" height="40px"
									onclick="javascript:this.src='${pageContext.request.contextPath }/<%=response.encodeURL("code")%>?id='+new Date().getMilliseconds()">
